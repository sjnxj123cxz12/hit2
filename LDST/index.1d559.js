...
var s = t("../../framework/common/Dialog"), a = t("../../framework/common/Tween"), c = t("../../framework/common/Utils"), l = t("./LodeSTConfig"), u = t("./LodeSTUtils"), d = t("./LodeSTView"), h = t("./network/LodeST.NetworkClient"), f = t("./tableft/LodeSTBet"), p = t("./LodeSTRoomID"), T = cc._decorator, _ = T.ccclass, b = T.property, g = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.lbPhien = null;
...
t.SessionInfo = o[0];
t.lbSessionId.string = "Phiên: #" + t.SessionInfo.SessionID;
if (t.SessionInfo.Phrase == u.default.GAMESTATE.BETTING) {
t.lbTime.node.color = cc.Color.BLUE;
t.popupResult.active = !1;
...
t.newSessionInfo.SpecialPrizeData = u.default.Utils.convertArrayToString(t.SessionInfo._SpecialPrizeData);
t.newSessionInfo.FirstPrizeData = u.default.Utils.convertArrayToString(t.SessionInfo._FirstPrizeData);
t.newSessionInfo.SecondPrizeData = u.default.Utils.convertArrayToString(t.SessionInfo._SecondPrizeData);
t.newSessionInfo.ThirdPrizeData = u.default.Utils.convertArrayToString(t.SessionInfo._ThirdPrizeData);
t.newSessionInfo.FourthPrizeData = u.default.Utils.convertArrayToString(t.SessionInfo._FourthPrizeData);
t.newSessionInfo.FifthPrizeData = u.default.Utils.convertArrayToString(t.SessionInfo._FifthPrizeData);
t.newSessionInfo.SixthPrizeData = u.default.Utils.convertArrayToString(t.SessionInfo._SixthPrizeData);
t.newSessionInfo.SeventhPrizeData = u.default.Utils.convertArrayToString(t.SessionInfo._SeventhPrizeData);
if (t.historySession && t.historySession[0] && t.historySession[0].SessionID != t.newSessionInfo.SessionID) {
t.historySession.unshift(t.newSessionInfo);
t.historySession.length > 5 && t.historySession.pop();
}
if (t.historySessionThongKe && t.historySessionThongKe[0] && t.historySessionThongKe[0].SessionID != t.newSessionInfo.SessionID) {
...
case "updateRoomTime":
t.SessionInfo.Phrase == u.default.GAMESTATE.BETTING ? u.default.Utils.formatTimeSession(t.lbTime, o[1]) : u.default.Utils.formatTimeSession(t.lbTime, 0);
if (t.SessionInfo.Phrase == u.default.GAMESTATE.SHAKING) {
t.lbPhien.string = "Phiên: #" + t.SessionInfo.SessionID.toString();
if (t.popupResult.active) switch (o[1]) {
case 14:
t.stopLoadingNode(9);
break;
...
var o;
e.instance = null;
r([ b(cc.Label) ], e.prototype, "lbPhien", void 0);
r([ b(cc.Label) ], e.prototype, "lbDBresult", void 0);
r([ b(cc.Label) ], e.prototype, "lbG1result", void 0);
r([ b(cc.Label) ], e.prototype, "lbG2result", void 0);
r([ b(cc.Label) ], e.prototype, "lbG3result", void 0);
r([ b(cc.Label) ], e.prototype, "lbG4result", void 0);
r([ b(cc.Label) ], e.prototype, "lbG5result", void 0);
r([ b(cc.Label) ], e.prototype, "lbG6result", void 0);
r([ b(cc.Label) ], e.prototype, "lbG7result", void 0);
r([ b(cc.Node) ], e.prototype, "LoadingNode", void 0);
r([ b([ cc.SpriteFrame ]) ], e.prototype, "listAvatar", void 0);
r([ b(cc.Sprite) ], e.prototype, "sprAvatar", void 0);
r([ b(cc.Label) ], e.prototype, "lbNickname", void 0);
r([ b(cc.Label) ], e.prototype, "lbGold", void 0);
r([ b(cc.Label) ], e.prototype, "lbTime", void 0);
r([ b(cc.Label) ], e.prototype, "lbSessionId", void 0);
r([ b(s.default) ], e.prototype, "msgSystem", void 0);
r([ b(cc.Label) ], e.prototype, "lbMsg", void 0);
r([ b(p.default) ], e.prototype, "nodeSelectRoomID", void 0);
r([ b([ cc.Button ]) ], e.prototype, "btnTables", void 0);
r([ b(f.default) ], e.prototype, "LodeSTBet", void 0);
r([ b(cc.Node) ], e.prototype, "popupResult", void 0);
return o = r([ _ ], e);
}(cc.Component);
o.default = g;
cc._RF.pop();
...
var s = t("../../../framework/common/Dialog"), a = t("../../../framework/common/Utils"), c = t("../LodeSTConfig"), l = t("../LodeSTController"), u = t("../LodeSTUtils"), d = t("../network/LodeST.Http"), h = t("../LodeSTRoomID"), f = cc._decorator, p = f.ccclass, T = f.property, _ = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
u.default.sendRequest("GET", a.default.App.HOST_LODE_SIEUTOC.host, "api/LodeSieuToc/GetSessionInfo?openDateFrom=" + this.strDateFrom + "&openDateTo=" + this.strDateTo + "&roomId=" + this.roomId + "&page=" + this.currentIndexPage + "&top=2", null, function(e, o) {
if (null == e) {
if (0 == o.Status) {
var n = o.PageCount;
t.totalPage = Math.floor(n / 2);
if (t.currentIndexPage >= t.totalPage) {
...
t.lbSession_1.string = r.SessionID;
...
t.lbSession_2.string = s.SessionID;
...
if (this.currentData) {
this.lbSession.string = "#" + this.currentData.SessionID;
...
if (this.nodeSelectSession.active) for (var t = 0; t < this.templateSessionId.length - 1; t++) null != s.default.instance.historySession[t].SessionID && (this.templateSessionId[t].getComponent(cc.Label).string = "#" + s.default.instance.historySession[t].SessionID);
};
e.prototype.atcSelectSession = function(t, e) {
var o = parseInt(e);
this.atcShowSession(null);
if (5 != o) {
this.currSession = s.default.instance.historySession[o].SessionID;
this.loadSession();
...
this.SessionID = 0;
this._SpecialPrizeData = new Array();
this._FirstPrizeData = new Array();
this._SecondPrizeData = new Array();
this._ThirdPrizeData = new Array();
this._FourthPrizeData = new Array();
this._FifthPrizeData = new Array();
this._SixthPrizeData = new Array();
this._SeventhPrizeData = new Array();
};
...
var s = t("../../framework/common/Utils"), a = t("./LodeSTController"), c = t("./LodeSTUtils"), l = t("./network/LodeST.NetworkClient"), u = t("./popups/LodeSTPopupBetHistory"), d = t("./popups/LodeSTPopupGuid"), h = t("./popups/LodeSTPopupHistorySession"), f = t("./popups/LodeSTPopupNumber"), p = cc._decorator, T = p.ccclass, _ = p.property, b = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.sprButton = [];
...
this.lbWinInBet.string = s.default.formatNumber(parseInt((1e3 * e).toFixed(0))) + "K";
this.lbTotalRecharge.string = s.default.formatNumber(1e3 * o) + "K";
} else {
this.lbWinInBet.string = "0K";
this.lbTotalRecharge.string = "0K";
}
};
...
var o;
e.instance = null;
r([ _([ cc.SpriteFrame ]) ], e.prototype, "sprButton", void 0);
r([ _([ cc.SpriteFrame ]) ], e.prototype, "sprButtonGate", void 0);
r([ _([ cc.Button ]) ], e.prototype, "btnGroup", void 0);
r([ _([ cc.Button ]) ], e.prototype, "btnGateBet", void 0);
r([ _([ cc.Node ]) ], e.prototype, "nodeGateBet", void 0);
r([ _(cc.RichText) ], e.prototype, "rtxtDescriptionsGate", void 0);
r([ _(cc.EditBox) ], e.prototype, "edBetData", void 0);
r([ _(cc.EditBox) ], e.prototype, "edBetMoney", void 0);
r([ _(cc.Label) ], e.prototype, "lbWinInBet", void 0);
r([ _(cc.Label) ], e.prototype, "lbTotalRecharge", void 0);
r([ _(d.default) ], e.prototype, "LodeSTPopupGuid", void 0);
r([ _(f.default) ], e.prototype, "LodeSTPopupNumber", void 0);
r([ _(h.default) ], e.prototype, "LodeSTPopupHistorySession", void 0);
r([ _(u.default) ], e.prototype, "LodeSTPopupBetHistory", void 0);
return o = r([ T ], e);
}(cc.Component);
o.default = b;
cc._RF.pop();
...
(e = cc.moveTo(.5, cc.v2(-440, 0))).easing(cc.easeQuadraticActionInOut());
