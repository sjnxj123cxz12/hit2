...
e.minMidPos = cc.v3(-100, 100, 0);
e.maxMidPos = cc.v3(100, 300, 0);
...
var c = e.getRandomRange(e.minMidPos.x, e.maxMidPos.x), l = e.getRandomRange(e.minMidPos.y, e.maxMidPos.y), p = cc.v3(c, l, 0);
cc.tween(o).delay(i).to(.3, {
position: p
}, {
easing: "sineInOut"
}).to(.3, {
...
a([ c(cc.Vec3) ], e.prototype, "minMidPos", void 0);
a([ c(cc.Vec3) ], e.prototype, "maxMidPos", void 0);
...
var r = t("./network/Volta.NetworkClient"), s = t("./Volta.Const"), c = cc._decorator, l = c.ccclass, p = c.property, u = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var r = t("../Volta.Const"), s = t("../Volta.MainGame"), c = cc._decorator, l = c.ccclass, p = c.property, u = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
if (t) for (var e = 0; e < t.length; e++) {
var o = t[e], n = o.CreateTime, i = o.TeamName, a = o.SessionID, s = o.Bet, c = o.Award, l = 0 == c ? c - s : c, p = cc.instantiate(this.template);
p.active = !0;
p.position = new cc.Vec3(0, 0, 0);
p.getChildByName("txtSeasion").getComponent(cc.Label).string = "ID: " + a;
if (n.length > 0) {
var u = r.VoltaConst.formatDateTime2(n);
p.getChildByName("txtNgay").getComponent(cc.Label).string = u;
}
if (l > 0) {
p.getChildByName("txtTienThang").getComponent(cc.Label).string = "+" + r.VoltaConst.formatNumberToKMB(l);
p.getChildByName("txtTienThang").color = cc.Color.GREEN;
} else if (l < 0) {
p.getChildByName("txtTienThang").getComponent(cc.Label).string = r.VoltaConst.formatNumberToKMB(l);
p.getChildByName("txtTienThang").color = cc.Color.RED;
}
p.getChildByName("txtTongCuoc").getComponent(cc.Label).string = r.VoltaConst.formatNumberToKMB(s);
p.getChildByName("txtDoiCuoc").getComponent(cc.Label).string = i;
p.getChildByName("txtTranDau").getComponent(cc.Label).string = "Volta - Bàn thắng vàng\n" + o.TeamA + " vs " + o.TeamB;
...
var r = t("./network/Volta.NetworkClient"), s = t("./Volta.Const"), c = t("./Volta.ThongKe"), l = t("./ChipMovent"), p = t("../../lobby/scripts/ChangeAvatar/ListAvatar"), u = cc._decorator, h = u.ccclass, f = u.property, d = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.m_nGameStatus = 0;
...
var o = this.nodeSelectChip, n = t.target;
this.indexChip = o.children.indexOf(n);
};
...
this.Md5AndResultText = this.m_nGameStatus == s.VoltaConst.GameStatus.RESULT && t.Ellapsed < 5 ? s.VoltaConst.cutStringWithEllipsis(t.ResultString, 18) : s.VoltaConst.cutStringWithEllipsis(t.Md5String, 19);
this.m_lblResuldMd5.string = this.Md5AndResultText;
this.btnCopy[1].active = this.m_nGameStatus == s.VoltaConst.GameStatus.RESULT && t.Ellapsed < 5;
...
if (this.m_nGameStatus == s.VoltaConst.GameStatus.RESULT) {
this.m_lblTimer.string = "";
this.m_lblTimer.node.active = !1;
clearInterval(this.ChipIntervalID);
}
cc.sys.isNative;
if (this.m_nGameStatus == s.VoltaConst.GameStatus.BETTING) this.nodeLive.active = !1; else if (this.m_nGameStatus == s.VoltaConst.GameStatus.RESULT && 0 == s.VoltaConst.isLoading && 0 == this.isPopupOpen) {
s.VoltaConst.urlVideo = "https://iuvtr.sb21.net/?link=" + t.VideoUrl;
this.nodeLive.active = !0;
}
if (this.m_nGameStatus == s.VoltaConst.GameStatus.RESULT && 0 == this.isShowResult && t.Ellapsed <= 5 && -1 != t.teamWin) {
this.isShowResult = !0;
this.showResult(e.teamWin);
}
}
};
...
l.default.instance.hideAndCollectChips(2);
} else if (t == s.VoltaConst.BetGate.GATE_AWAY) {
this.nodeAwayWin.active = !0;
l.default.instance.hideAndCollectChips(1);
}
this.isSpawnChip = !1;
...
if (this.m_nGameStatus != s.VoltaConst.GameStatus.RESULT && this.m_nGameStatus != s.VoltaConst.GameStatus.PREPARE_NEW_SESSION && this.m_nGameStatus != s.VoltaConst.GameStatus.END_BETTING) {
r.default.instance.sendSignalR("Bet", [ this.m_llBetValue, this.m_nBetGate, 1 ]);
l.default.instance.spawnChipPlayer(this.m_nBetGate + 1, this.indexChip);
...
a([ f(p.default) ], e.prototype, "SpritetAvatar", void 0);
...
var e = this, o = "https://volta." + lngui.ConfigManager.instance.ConfigInfo.Api + "/api/volta/GetSessionHistory?access_token=" + lngui.UserManager.instance.mainUserInfo.GameToken + "&pageIndex=" + t + "&pageSize=" + this.pageSize;
lngui.Https.get(o, function(t) {
if (t) {
lngui.UIWaitingLayout.hideWaiting();
e.pageIndex = t.PageIndex;
...
var n = t[e], i = n.CreatedDate, a = n.TeamA, s = n.TeamB, c = 0 == n.TeamWin ? a : s, l = r.VoltaConst.cutStringWithEllipsis(n.Md5String, 9), p = r.VoltaConst.cutStringWithEllipsis(n.ResultString, 8), u = cc.instantiate(o.template);
u.active = !0;
u.position = new cc.Vec3(0, 0, 0);
if (i.length > 0) {
var h = r.VoltaConst.formatDateTime2(i);
u.getChildByName("txtNgay").getComponent(cc.Label).string = h;
}
u.getChildByName("txtMd5").getComponent(cc.Label).string = l;
u.getChildByName("txxResult").getComponent(cc.Label).string = p;
u.getChildByName("txtDoiThang").getComponent(cc.Label).string = c;
u.getChildByName("txtDoiBong").getComponent(cc.Label).string = a + "\n" + s;
u.getChildByName("btnCopyMd5").getComponent(cc.Button).node.on("click", function() {
t = n.Md5String, lngui.PlatformInterface.copy(t);
var t;
});
u.getChildByName("btnCopyResult").getComponent(cc.Button).node.on("click", function() {
t = n.ResultString, lngui.PlatformInterface.copy(t);
var t;
});
u.getChildByName("liner").active = !(e % 2);
o.content.addChild(u);
...
if (o > 31) break;
var s = cc.instantiate(this.template);
s.position = new cc.Vec3(0, 0);
s.active = !0;
s.getComponent(cc.Sprite).spriteFrame = "H" === r ? this.ellipseHome : this.ellipseAway;
s.setPosition(this.getPosforSC(o, e));
this.pnlSC.addChild(s);
}
};
